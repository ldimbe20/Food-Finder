...
export const Severities = () => {
    ...
    useEffect(
        () => {
            friendFoodRestriction.filter((friend) => {
                                ...
                                return (
                                    <div className="Source">
                                        <>  <h3 className="Level"><b>Level 4</b></h3>
                                            ...
                                            <p className="Description">Use epinephrine. This medicine is injected under the skin or into the muscle of your outer thigh only. Do not inject this medicine into a vein, into the muscle of your buttocks, or into your fingers, toes,
                                                hands, or feet. To do so, may increase the chance of having serious side effects. <b>SEEK EMERGENCY ASSISTANCE</b></p>
                                            <p className="people__Allergy">
                                    ...
                                    <div className="Source">
                                        <>   <h3 className="Level"><b>Level 3</b></h3>
                                            <p className="Description">
                                                ...
                                                Wheezing, nasal congestion or trouble breathing</p>
                                            <h4 className="Treatment">Treatment:</h4>
                                            <p className="Description">Depending on severity use epinephrine. This medicine is injected under the skin or into the muscle of your outer thigh only. Do not inject this medicine into a vein, into the muscle of your buttocks, or into your
                                                fingers, toes, hands, or feet. To do so, may increase the chance of having serious side effects. </p>
                                            <p className="people__Allergy">
                                ...
                                return (
                                    <div className="Source">
                                        <>
                                            ...
                                            <p className="Description">
                                                Hives, itching or eczema. Swelling of the lips, face, tongue and throat or other parts of the body</p>
                                            <h4 className="Treatment">Treatment:</h4>
                                            <p className="Description">Depending on severity use common allergy medicines such as benedryl, antihistamines, adrenaline. Adrenaline may be needed. </p>
